...
| **training-battle-designer** | -- | Training-battle (xunzhan jiehe) talent development: strategic reserve bootcamps, real-project combat, case-based learning. | Huawei training system |
