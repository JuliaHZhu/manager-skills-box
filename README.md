...
| **book-card-git-manager** | — | Git strategy for book-to-learn card projects: .gitignore generation, source vs artifact separation, rebuild commands, cross-device migration. | book-to-learn toolchain |
...
| **sp-budget-closure** | — | Strategy-to-budget closed loop: SP→BP→budget alignment, forced variance explanation, rolling monitoring with红绿灯. | Huawei finance management |
...
| **internal-service-marketizer** | — | Internal service marketization: basic/增值分层, privatization + competition, dynamic rent + survival-of-the-fittest. | Huawei admin management |
...
| **financial-risk-three-lines** | — | Financial risk 4×3 architecture: three risk categories, three defense lines, three-layer review, triangular linkage, financial blue team. | Huawei financial management |
...
| **cadre-culling-protocol** | — | Cadre culling and laziness governance: 13 unfit cadre types, 18 laziness behavior checklist,末位淘汰, and up-down mobility enforcement. | Huawei cadre management |
...
| **pfc-pipeline-cultivator** | — | PFC (Project Financial Controller) cultivation: four basic requirements, four growth directions,补课+exam training, five excellence characteristics. | Huawei financial management |
